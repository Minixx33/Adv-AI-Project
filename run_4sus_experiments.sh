...
#   bash /mnt/c/Users/yasmi/OneDrive/Desktop/Github/Adv-AI-Project/run_mixed4_experiments.sh
#
# Output lands in:
#   Model_V2/results/<agent>_4sus_seed<N>_<timestamp>/
